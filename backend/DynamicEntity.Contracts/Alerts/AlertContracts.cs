...
public sealed record AlertNotificationResponse(Guid Id,Guid AlertId,Guid EvaluationId,string Channel,NotificationStatus Status,int Attempts,string? LastError,DateTimeOffset CreatedAt,DateTimeOffset? DeliveredAt,DateTimeOffset? NextAttemptAt);
